...
| [Nexty.dev（付费）](https://nexty.dev) | Next.js。多场景全栈模板，集成了登录、支付（stripe）、邮件、AI功能，且均内置了开箱即用的一次性付费、订阅的完整流程  |
...
| [db4free](https://db4free.net/) | 免费 MySQL，国外服务器，200MB存储空间 |
| [sqlpub](https://sqlpub.com/) | 免费 MySQL，国内服务器，最大36000次/小时的请求，500M存储空间 |
